...
const (
	...
	// SelectProductByID = "SELECT product_id, product_name, product_amount, product_user_created, product_date_created, product_user_modify, product_date_modify FROM public.products WHERE product_id = 1"
)
